...
const InputRowApp: React.FC<InputRowAppProps> = ({ 
    formik, 
    statusOptions, 
    setIsAddingNew, 
    onCancel,
        ...
        <tr className="bg-fuchsia-50 border-l-4 border-fuchsia-500" onKeyDown={handleKeyPress}>
            ...
            <td className="px-3 py-2 md:px-6 md:py-4">
                <FormInput
                    ...
                    onChange={(value) => formik.setFieldValue('contact_email', value || null)}
...
export default React.memo(InputRowApp);