...
interface ResumeFooterAppProps {
...
const ResumeFooterApp: React.FC<ResumeFooterAppProps> = ({ filteredAndSortedApplications, applications }) => {
    return (
...
export default ResumeFooterApp